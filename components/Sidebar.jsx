...
const Sidebar = () => {
    return (
        <div className="flex flex-col gap-4">
            ...
            <button className="bg-blue-400 text-white cursor-pointer hover:brightness-95 rounded-full w-48 h-9 transition duration-150 ease-in-out hidden lg:inline shadow-md">
                Sign In
            </button>
        </div>
    )
